    ...
    <Dialog as="div" @close="closeModal" class="relative z-[50]">
      ...
      <div class="fixed inset-0 overflow-y-auto">
        <div class="flex min-h-full items-center justify-center p-4">
          ...
          >
            <DialogPanel
              class="flex w-full max-w-sm transform overflow-hidden rounded-2xl bg-black p-6 shadow-xl transition-all"
            >
              <div class="w-full mx-auto pr-4 gap-5">
                <DialogTitle
                  as="h3"
                  class="text-lg font-medium leading-6 text-white mb-4"
                  >¡Agrega la canción a una Playlist!</DialogTitle
                >
                <label
                  for="playlists"
                  class="block mb-2 text-sm font-medium text-gray-400"
                  >Selecciona una Playlist:</label
                >
                <select
                  id="playlists"
